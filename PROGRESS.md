...
Stage 0, colour slice 1. Phase: spec 003 implementing, task 5 of 9 done. Next action: run the package targets in CI (task 6).

## Specs

| Stage | Spec                       | Status       | Next action                            | Who   | Updated    |
| ----- | -------------------------- | ------------ | -------------------------------------- | ----- | ---------- |
| 0     | `003-colour-tokens-build`  | implementing | Run the package targets in CI (task 6) | agent | 2026-09-23 |
