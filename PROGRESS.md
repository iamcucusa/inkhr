...
Stage 0, colour slice 1. Phase: spec 005 implementing, task 3 of 10 done. Next action: bring GAPS.md up to date (task 4).

## Specs

| Stage | Spec                      | Status       | Next action                       | Who   | Updated    |
| ----- | ------------------------- | ------------ | --------------------------------- | ----- | ---------- |
| 0     | `005-colour-tokens-names` | implementing | Bring GAPS.md up to date (task 4) | agent | 2026-09-23 |
