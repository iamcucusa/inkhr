...
Stage 0, colour slice 1. Phase: spec 005 implementing, task 4 of 10 done. Next action: mark the wrong examples in the package map (task 5).

## Specs

| Stage | Spec                      | Status       | Next action                                         | Who   | Updated    |
| ----- | ------------------------- | ------------ | --------------------------------------------------- | ----- | ---------- |
| 0     | `005-colour-tokens-names` | implementing | Mark the wrong examples in the package map (task 5) | agent | 2026-09-23 |
