...
Stage 0, colour slice 1. Phase: spec 004 implementing, task 8 of 10 done. Next action: add the changeset (task 9).

## Specs

| Stage | Spec                       | Status       | Next action                       | Who   | Updated    |
| ----- | -------------------------- | ------------ | --------------------------------- | ----- | ---------- |
| 0     | `004-colour-tokens-check`  | implementing | Add the changeset (task 9)        | agent | 2026-09-23 |
