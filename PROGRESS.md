...
Stage 0, colour slice 1. Phase: spec 003 in review, task 8 of 9 done. Next action: open the pull request, then the design lead reads the output diff and rebase merges.

## Specs

| Stage | Spec                       | Status      | Next action                             | Who         | Updated    |
| ----- | -------------------------- | ----------- | --------------------------------------- | ----------- | ---------- |
| 0     | `003-colour-tokens-build`  | in review   | Read the output diff, then rebase merge | design lead | 2026-09-23 |
