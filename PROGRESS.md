...
Stage 0, colour slice 1. Phase: spec 005 implementing, task 2 of 10 done. Next action: correct the colour names in DESIGN.md (task 3).

## Specs

| Stage | Spec                      | Status       | Next action                                    | Who   | Updated    |
| ----- | ------------------------- | ------------ | ---------------------------------------------- | ----- | ---------- |
| 0     | `005-colour-tokens-names` | implementing | Correct the colour names in DESIGN.md (task 3) | agent | 2026-09-23 |
