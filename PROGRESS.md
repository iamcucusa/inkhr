...
Stage 0, colour slice 1. Phase: spec 004 tests committed, task 2 of 10 done. Next action: check with Terrazzo's rules (task 3).

## Specs

| Stage | Spec                       | Status          | Next action                          | Who   | Updated    |
| ----- | -------------------------- | --------------- | ------------------------------------ | ----- | ---------- |
| 0     | `004-colour-tokens-check`  | tests committed | Check with Terrazzo's rules (task 3) | agent | 2026-09-23 |
