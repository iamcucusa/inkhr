...
Stage 0, colour slice 1. Phase: spec 004 implementing, task 3 of 10 done. Next action: add the InkHR rules (task 4).

## Specs

| Stage | Spec                       | Status       | Next action                       | Who   | Updated    |
| ----- | -------------------------- | ------------ | --------------------------------- | ----- | ---------- |
| 0     | `004-colour-tokens-check`  | implementing | Add the InkHR rules (task 4)      | agent | 2026-09-23 |
