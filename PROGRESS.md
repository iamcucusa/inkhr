...
Stage 0, colour slice 1. Phase: spec 005 tests committed, task 1 of 10 done. Next action: add the name check (task 2).

## Specs

| Stage | Spec                      | Status          | Next action                 | Who   | Updated    |
| ----- | ------------------------- | --------------- | --------------------------- | ----- | ---------- |
| 0     | `005-colour-tokens-names` | tests committed | Add the name check (task 2) | agent | 2026-09-23 |
