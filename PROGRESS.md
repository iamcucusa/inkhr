...
Stage 0, colour slice 1. Phase: spec 003 implementing, task 6 of 9 done. Next action: record the commands and the colour build (task 7).

## Specs

| Stage | Spec                       | Status       | Next action                                       | Who   | Updated    |
| ----- | -------------------------- | ------------ | ------------------------------------------------- | ----- | ---------- |
| 0     | `003-colour-tokens-build`  | implementing | Record the commands and the colour build (task 7) | agent | 2026-09-23 |
