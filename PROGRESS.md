...
Stage 0, colour slice 1. Phase: spec 004 implementing, task 7 of 10 done. Next action: record the check in the docs (task 8).

## Specs

| Stage | Spec                       | Status       | Next action                           | Who   | Updated    |
| ----- | -------------------------- | ------------ | ------------------------------------- | ----- | ---------- |
| 0     | `004-colour-tokens-check`  | implementing | Record the check in the docs (task 8) | agent | 2026-09-23 |
