...
Stage 0, colour slice 1. Phase: spec 004 implementing, task 6 of 10 done. Next action: add the agent hooks (task 7).

## Specs

| Stage | Spec                       | Status       | Next action                       | Who   | Updated    |
| ----- | -------------------------- | ------------ | --------------------------------- | ----- | ---------- |
| 0     | `004-colour-tokens-check`  | implementing | Add the agent hooks (task 7)      | agent | 2026-09-23 |
