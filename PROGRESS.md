...
Stage 0, colour slice 1. Phase: spec 003 tests committed, task 3 of 9 done. Next action: build the colour outputs (task 4).

## Specs

| Stage | Spec                       | Status          | Next action                       | Who   | Updated    |
| ----- | -------------------------- | --------------- | --------------------------------- | ----- | ---------- |
| 0     | `003-colour-tokens-build`  | tests committed | Build the colour outputs (task 4) | agent | 2026-09-23 |
