...
Stage 0, colour slice 1. Phase: spec 005 implementing, task 5 of 10 done. Next action: run the name check before commits, finishing and in CI (task 6).

## Specs

| Stage | Spec                      | Status       | Next action                                                     | Who   | Updated    |
| ----- | ------------------------- | ------------ | --------------------------------------------------------------- | ----- | ---------- |
| 0     | `005-colour-tokens-names` | implementing | Run the name check before commits, finishing and in CI (task 6) | agent | 2026-09-23 |
