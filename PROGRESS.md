...
Stage 0, colour slice 1. Phase: spec 003 implementing, task 7 of 9 done. Next action: add the changeset (task 8).

## Specs

| Stage | Spec                       | Status       | Next action                       | Who   | Updated    |
| ----- | -------------------------- | ------------ | --------------------------------- | ----- | ---------- |
| 0     | `003-colour-tokens-build`  | implementing | Add the changeset (task 8)        | agent | 2026-09-23 |
