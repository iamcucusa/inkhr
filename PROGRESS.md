...
Stage 0, colour slice 1. Phase: spec 005 drafted. Next action: the design lead approves `specs/005-colour-tokens-names`.

## Specs

| Stage | Spec                      | Status  | Next action      | Who         | Updated    |
| ----- | ------------------------- | ------- | ---------------- | ----------- | ---------- |
| 0     | `005-colour-tokens-names` | drafted | Approve the spec | design lead | 2026-09-23 |
