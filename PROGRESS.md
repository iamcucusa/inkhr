...
Stage 0, colour slice 1. Phase: spec 004 in review, task 9 of 10 done. Next action: open the pull request, then the design lead reviews and rebase merges.

## Specs

| Stage | Spec                       | Status      | Next action                                | Who         | Updated    |
| ----- | -------------------------- | ----------- | ------------------------------------------ | ----------- | ---------- |
| 0     | `004-colour-tokens-check`  | in review   | Review the pull request, then rebase merge | design lead | 2026-09-23 |
