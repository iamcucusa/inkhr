...
Stage 0, colour slice 1. Phase: spec 005 implementing, task 7 of 10 done. Next action: write the rule file (task 8).

## Specs

| Stage | Spec                      | Status       | Next action                  | Who   | Updated    |
| ----- | ------------------------- | ------------ | ---------------------------- | ----- | ---------- |
| 0     | `005-colour-tokens-names` | implementing | Write the rule file (task 8) | agent | 2026-09-23 |
