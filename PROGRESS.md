...
Stage 0, colour slice 1. Phase: spec 003 implementing, task 4 of 9 done. Next action: type-check the built declarations (task 5).

## Specs

| Stage | Spec                       | Status       | Next action                                | Who   | Updated    |
| ----- | -------------------------- | ------------ | ------------------------------------------ | ----- | ---------- |
| 0     | `003-colour-tokens-build`  | implementing | Type-check the built declarations (task 5) | agent | 2026-09-23 |
