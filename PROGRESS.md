...
Stage 0, colour slice 1. Phase: spec 005 implementing, task 6 of 10 done. Next action: write the failing rule file test (task 7).

## Specs

| Stage | Spec                      | Status       | Next action                               | Who   | Updated    |
| ----- | ------------------------- | ------------ | ----------------------------------------- | ----- | ---------- |
| 0     | `005-colour-tokens-names` | implementing | Write the failing rule file test (task 7) | agent | 2026-09-23 |
