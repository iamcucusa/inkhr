...
- This spec states the rules and how they are enforced. `design.md` is their source until `docs/commit-guide.md` exists, and the earlier hand-over note in `specs/` is removed by the last task.
...
9. The earlier hand-over note is removed, and everything that referred to it points at the guide or this spec.
