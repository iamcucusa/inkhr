...
3. Node 22 or later is required and declared in `package.json` `engines`. npm is the package manager, and `package-lock.json` is committed.
...
- CI workflows and the seven gates.
- Git hooks and Claude Code hooks (`specs/commit-rules-setup.md`).
